...
public class utilityAppache {
        ...
        public static void setCellData(String Result, int RowNum, int ColNum, String pathTestData, String fileTestData) {
            ...
            try {
                ...
                FileOutputStream fileOut = new FileOutputStream(pathTestData + fileTestData);
